...
if __name__ == "__main__":
    ...
    if no_proc_flag:
        ...
        with open(args.ckpt.parents[0] / "hparams.yaml", "r") as f:
        ...
        # load validation dataset
            ...
            print(config["datamodule"].keys())
            for split in ["val", "train", "libri-clean", "libri-noisy"]:
                ...
                if not data_path.exists():
                    config["datamodule"][split]["dataset"]["path"] = "/data/milsrg1/corpora/LibriMix"
            ...
            datasets["libri-clean"] = WSJ0_mix(**config["datamodule"]["libri-clean"]["dataset"])
            #datasets["librimix_train-100"] = WSJ0_mix(**config["datamodule"]["librimix_train-100"]["dataset"])
            #datasets["librimix_train-360"] = WSJ0_mix(**config["datamodule"]["librimix_train-360"]["dataset"])
