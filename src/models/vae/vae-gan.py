"""
This model takes the EnCodec model and proposes instead a VAE-GAN compressor instead of RVQ-VAE.
https://github.com/OpenNSP/Hifi-vaegan/blob/main/modules/modules.py
"""
...
from src.models.vae.utils import get_padding, init_weights
from src.models.vae.msstftd import MultiScaleSTFTDiscriminator
