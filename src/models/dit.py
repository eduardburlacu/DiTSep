...
class DiTSepModel(ModelMixin, ConfigMixin):
    """
    Parameters:
        ...
        attention_head_dim (`int`, *optional*, defaults to 64): The numbber of heads to use for the query states.
        num_key_value_attention_heads (`int`, *optional*, defaults to 12):
            The number of heads to use for the key and value states.er of channels in each head.
        num_attention_heads (`int`, *optional*, defaults to 24): The num
